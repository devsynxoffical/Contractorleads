...
export const MARKETING_PLANS: MarketingPlanCard[] = [
  {
    ...
    creditsLabel: "13.3 credits (10 leads)",
    creditsDetail: "1.33 credits per lead · your first 10 leads are on us",
    ctaLabel: "Get started free",
    ctaHref: "/register",
    trialOffer: true,
    features: [
      "10 free leads on signup (13.3 credits)",
  ...
  },
  {
    ...
    creditsLabel: "133 credits / mo (~100 leads)",
  ...
  },
  {
    ...
    creditsLabel: "266 credits / mo (~200 leads)",
  ...
  },
  {
    ...
    creditsLabel: "Custom credits (1.33 / lead)",
    creditsDetail: "Volume pricing · dedicated pool + SLA",
