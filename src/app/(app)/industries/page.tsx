  ...
  return (
    <div className="page-pad page-enter">
      <div className="mesh-bg -mx-4 -mt-4 mb-6 rounded-b-2xl px-4 pb-6 pt-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <PageHeader
          title="Industries"
          description="12 home-service verticals covered across all 50 states — pick one and jump into Lead Finder."
          actions={
        ...
        <div className="stagger grid gap-3 sm:grid-cols-3">
          <div className="rounded-xl border border-border bg-white/90 px-4 py-3 shadow-sm">
            ...
            <p className="mt-1 text-lg font-semibold">50 states</p>
          </div>
          <div className="rounded-xl border border-border bg-white/90 px-4 py-3 shadow-sm">
      ...
      <SectionHeading
        title="All verticals"
        description="Each card opens Lead Finder so you can set state, city, and radius."
      />
            ...
            <Card className="hover-lift h-full border-border shadow-[var(--shadow-card)]">
              <CardContent className="py-4">
                ...
                <p className="mt-2 text-[12px] leading-relaxed text-ink-muted">
                  {INDUSTRY_HINTS[industry] ?? "Verified US contractors"}
                </p>
