  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[980px]">
        ...
        <div
          ref={shellRef}
          className="relative overflow-hidden rounded-[18px] border border-white/15 bg-[#ece9f2] shadow-[0_24px_64px_rgba(0,0,0,0.45)] ring-1 ring-white/10 sm:rounded-[20px]"
        >
          ...
          <div className="flex min-h-[390px] max-h-[min(64vh,500px)] lg:min-h-[430px]">
